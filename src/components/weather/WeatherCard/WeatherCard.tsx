...
const WeatherCard: React.FC<WeatherCardProps> = ({ weather, onClick }) => {
  ...
  const getTemperatureClass = (temp: number) => {
    if (temp <= 0) return "weather-card__temperature--cold";
    if (temp <= 15) return "weather-card__temperature--cool";
    if (temp <= 25) return "weather-card__temperature--warm";
  ...
  return (
    ...
    >
      ...
      <div className="weather-card__main">
        <div className={`weather-card__temperature ${getTemperatureClass(weather.temperature)}`}>
