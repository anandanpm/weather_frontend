  ...
  return (
    ...
    >
      <div className="weather-search__input-group">
        ...
        <button type="submit" className="weather-search__button" disabled={loading || !city.trim()}>
          <Search className="weather-search__button-icon" />
          <span className="weather-search__button-text">{loading ? "Searching..." : "Search"}</span>
        </button>
      </div>
    </motion.form>
  )
